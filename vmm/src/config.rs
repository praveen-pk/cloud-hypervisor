...
impl LandlockConfig {
    ...
    pub fn parse(landlock_rule: &str) -> Result<Self> {
        ...
        let mut path_perms = landlock::Perms::empty();
        let flags = parser
            .get("flags")
            .ok_or(Error::ParseLandlockMissingFields)?;
        ...
        for c in flags.chars() {
            match c {
                'r' => path_perms |= landlock::Perms::READ,
                'w' => path_perms |= landlock::Perms::WRITE,
                'x' => path_perms |= landlock::Perms::EXECUTE,
                _ => {
    ...
    fn test_landlock_parsing() -> Result<()> {
        ...
        assert_eq!(
            ...
            LandlockConfig {
                ...
                perms: landlock::Perms::READ | landlock::Perms::WRITE,
            }
        );
        assert_eq!(
